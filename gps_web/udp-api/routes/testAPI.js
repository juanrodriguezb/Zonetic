...
function Getusers(){
  ...
  return new Promise((resolve,reject)=>{
    con.query(("SELECT DISTINCT truck FROM truckdata;"),
      function(err,result){
...
function GetLast(truck){
  ...
  return new Promise((resolve,reject)=>{
    con.query((("SELECT lat,lng,alt,timegps FROM truckdata WHERE truck = ").concat((truck).toString()," ORDER BY id desc limit 1")),
